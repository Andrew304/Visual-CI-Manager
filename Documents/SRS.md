...
3.1.1.4 [Выбор CI-сценария пользователя](#3.1.1.4)  
3.1.1.5 [Поиск CI-сценария пользователя по названию](#3.1.1.5)  
3.1.1.6 [Создание CI-сценария пользователя](#3.1.1.6)  
3.1.1.7 [Редактирование CI-сценария пользователя](#3.1.1.7)  
3.1.1.8 [Удаление CI-сценария пользователя](#3.1.1.8)  
...
При отсутствии у пользователя аккаунта ему необходимо его зарегистрировать. Для этого пользователю будет предоставлена форма регистрации.  
...
#### 3.1.1.4 Выбор CI-сценария пользователя <a name="3.1.1.4"></a>
Для авторизованного пользователя веб-приложение должно предоставлять возможность выбора CI-сценария из списка сохраненных CI-сценариев пользователя.

#### 3.1.1.5 Поиск CI-сценария пользователя по названию <a name="3.1.1.5"></a>
...
#### 3.1.1.6 Создание CI-сценария пользователя <a name="3.1.1.6"></a>
...
#### 3.1.1.7 Редактирование CI-сценария пользователя <a name="3.1.1.7"></a>
...
#### 3.1.1.8 Удаление CI-сценария пользователя <a name="3.1.1.8"></a>
...
В веб-приложении должен использоваться интуитивно понятный пользователю интерфейс. Информация, которой оперирует приложение, не должна иметь двухсмысленных значений.
...
Веб-приложение должно выполнять поставленные задачи и в любой ситуации обеспечивать сохранность данных, с которыми работает пользователь, также приложение должно корректно обрабатывать непредвиденные действия со стороны пользователя.
